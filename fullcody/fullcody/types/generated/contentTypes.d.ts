...
export interface ApiHomeHome extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    sliding1: Schema.Attribute.Component<'sliding1.sliding1', true>;
    sliding2: Schema.Attribute.Component<'sliding2.sliding2', true>;
    platform: Schema.Attribute.Component<'cody-platform.platform', true>;
    solution: Schema.Attribute.Component<'cody-solution.solution', true>;
    feature: Schema.Attribute.Component<'cody-feature.feature', true>;
    event: Schema.Attribute.Component<'cody-event.event', true>;
    comment: Schema.Attribute.Component<'cody-comment.comment', true>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
